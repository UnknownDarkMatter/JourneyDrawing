...
export function toLatLon(easting:number, northing:number, zoneNum:number,
     zoneLetter:string, northern:boolean|undefined, strict:boolean|undefined) {
...
export function fromLatLon(latitude:number, longitude:number, forceZoneNum:number|undefined = undefined) :UtmCoordinates{
